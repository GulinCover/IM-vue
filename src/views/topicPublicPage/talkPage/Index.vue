    ...
    <main>
      ...
      <div class="content">
        <div class="content-desc">
          <h4>{{locale.topicTalkPageH4}}</h4>
          <p>{{locale.topicTalkPageP}}</p>
        </div>
              ...
              <li>
                ...
                <div class="comment-content">
                  ...
                  <div class="comment-content-wrapper">
                    ...
                    <p>
                      <span>2020/01/01 12:12</span>
                      <span>
                        <thumbs-up-icon size="14"/>
                        12
                      </span>
                      <span>
                        <thumbs-down-icon size="14"/>
                      </span>
                    </p>
                  </div>
                </div>
        ...
        <p>
          <at-sign-icon size="14"/>
          <span v-html="locale.proTipTalk"></span>
        </p>
      </div>
    </main>
...
import {AlertCircleIcon,AtSignIcon,ChevronLeftIcon,ThumbsUpIcon,ThumbsDownIcon,TwitchIcon,ChevronRightIcon} from "vue-feather-icons"
export default {
  name: "Index",
  components: {
    HeaderComponent,
    BottomComponent,
    TopBar,
    AlertCircleIcon,AtSignIcon,ChevronLeftIcon,ThumbsUpIcon,ThumbsDownIcon,TwitchIcon,ChevronRightIcon
  },
  data() {
    return {
      locale:this.$locale
